...
type ServerInterface interface {
	...
	SetChatRequireAuthentication(w http.ResponseWriter, r *http.Request)
	...
	GetFeatureRequests(w http.ResponseWriter, r *http.Request)
	...
	GetAdminFederatedServers(w http.ResponseWriter, r *http.Request)
	...
	// Create a clip from a recorded stream
	// (POST /clip)
	AddClip(w http.ResponseWriter, r *http.Request)
	// Get a list of all created clips
	// (GET /clips)
	...
	// Get a list of all available stream replays
	// (GET /replays)
...
// Set require authentication for chat
// (POST /admin/config/chat/requireauthentication)
func (_ Unimplemented) SetChatRequireAuthentication(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Get pending requests from other servers to feature this server's stream
// (GET /admin/federation/feature-requests)
func (_ Unimplemented) GetFeatureRequests(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Get all federated servers (admin), including pending requests
// (GET /admin/federation/servers)
func (_ Unimplemented) GetAdminFederatedServers(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) SetChatRequireAuthentication(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.SetChatRequireAuthentication(w, r)
	}))
...
func (siw *ServerInterfaceWrapper) GetFeatureRequests(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetFeatureRequests(w, r)
	}))
...
func (siw *ServerInterfaceWrapper) GetAdminFederatedServers(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetAdminFederatedServers(w, r)
	}))
...
func (siw *ServerInterfaceWrapper) GetViewersOverTime(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "windowStart", r.URL.Query(), &params.WindowStart, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
		var requiredError *runtime.RequiredParameterError
		if errors.As(err, &requiredError) {
			siw.ErrorHandlerFunc(w, r, &RequiredParamError{ParamName: "windowStart"})
		} else {
...
func (siw *ServerInterfaceWrapper) RegisterFediverseOTPRequest(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, true, "accessToken", r.URL.Query(), &params.AccessToken, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
		var requiredError *runtime.RequiredParameterError
		if errors.As(err, &requiredError) {
...
func (siw *ServerInterfaceWrapper) RegisterAnonymousChatUser(w http.ResponseWriter, r *http.Request) {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Forwarded-User")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "X-Forwarded-User", valueList[0], &XForwardedUser, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""})
		if err != nil {
...
func (siw *ServerInterfaceWrapper) SendSystemMessageToConnectedClientOptions(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "clientId", chi.URLParam(r, "clientId"), &clientId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: ""})
	if err != nil {
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/admin/config/chat/requireauthentication", wrapper.SetChatRequireAuthentication)
	})
	r.Group(func(r chi.Router) {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/admin/federation/servers", wrapper.GetAdminFederatedServers)
	})
	r.Group(func(r chi.Router) {
