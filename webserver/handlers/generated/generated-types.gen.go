...
// HandleIndieAuthEndpointPost200JSONResponseBody defines parameters for HandleIndieAuthEndpointPost.
type HandleIndieAuthEndpointPost200JSONResponseBody struct {
	union json.RawMessage
}
...
// SetFaviconJSONRequestBody defines body for SetFavicon for application/json ContentType.
type SetFaviconJSONRequestBody = AdminConfigValue
...
// AsIndieAuthResponse returns the union data inside the HandleIndieAuthEndpointPost200JSONResponseBody as a IndieAuthResponse
func (t HandleIndieAuthEndpointPost200JSONResponseBody) AsIndieAuthResponse() (IndieAuthResponse, error) {
	var body IndieAuthResponse
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromIndieAuthResponse overwrites any union data inside the HandleIndieAuthEndpointPost200JSONResponseBody as the provided IndieAuthResponse
func (t *HandleIndieAuthEndpointPost200JSONResponseBody) FromIndieAuthResponse(v IndieAuthResponse) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeIndieAuthResponse performs a merge with any union data inside the HandleIndieAuthEndpointPost200JSONResponseBody, using the provided IndieAuthResponse
func (t *HandleIndieAuthEndpointPost200JSONResponseBody) MergeIndieAuthResponse(v IndieAuthResponse) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsIndieAuthServerProfileResponse returns the union data inside the HandleIndieAuthEndpointPost200JSONResponseBody as a IndieAuthServerProfileResponse
func (t HandleIndieAuthEndpointPost200JSONResponseBody) AsIndieAuthServerProfileResponse() (IndieAuthServerProfileResponse, error) {
	var body IndieAuthServerProfileResponse
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromIndieAuthServerProfileResponse overwrites any union data inside the HandleIndieAuthEndpointPost200JSONResponseBody as the provided IndieAuthServerProfileResponse
func (t *HandleIndieAuthEndpointPost200JSONResponseBody) FromIndieAuthServerProfileResponse(v IndieAuthServerProfileResponse) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeIndieAuthServerProfileResponse performs a merge with any union data inside the HandleIndieAuthEndpointPost200JSONResponseBody, using the provided IndieAuthServerProfileResponse
func (t *HandleIndieAuthEndpointPost200JSONResponseBody) MergeIndieAuthServerProfileResponse(v IndieAuthServerProfileResponse) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t HandleIndieAuthEndpointPost200JSONResponseBody) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *HandleIndieAuthEndpointPost200JSONResponseBody) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
